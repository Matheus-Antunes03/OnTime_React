...
export function Edita_Clientes() {
                        ...
                        <tbody>
                            {usuarios.map((usuario) => (
                                <tr key={usuario.id}><td>
                                    ...
                                    <td contenteditable='true'>{usuario.dataNasc}</td>
                                    <td contenteditable='true'>{usuario.telefone}</td>
                                    <td contenteditable='true'>{usuario.cpf}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
