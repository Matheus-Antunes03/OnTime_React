...
export function Edita_Estabelecimentos() {
                    ...
                    <tbody>
                        {estabelecimentos.map((estabelecimento) => (
                            <tr key={estabelecimento.id}>
                                ...
                                <td contenteditable='true'>{estabelecimento.nome}</td>
                                <td contenteditable='true'>{estabelecimento.endereco}</td>
                                <td contenteditable='true'>{estabelecimento.inscricaoMunicipal}</td>
                                <td contenteditable='true'>{estabelecimento.cnpj}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
